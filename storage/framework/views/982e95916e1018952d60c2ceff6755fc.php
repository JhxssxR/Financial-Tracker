        ...
        <div style="background:#0b1220;border:1px solid #334155;border-radius:12px;padding:16px;margin-bottom:20px;" id="current-currency-display">
            ...
            <div style="display:flex;align-items:center;gap:12px;">
                <div style="width:40px;height:40px;background:#1e293b;border-radius:8px;display:grid;place-items:center;font-weight:700;font-size:14px;color:#10b981;" id="current-currency-code">
                    <?php echo e(Auth::user()->currency_code ?? 'EUR'); ?>
                ...
                <div>
                    ...
                    <div class="muted" style="font-size:13px;" id="current-currency-symbol"><?php echo e(Auth::user()->currency_symbol ?? '€'); ?> <?php echo e(Auth::user()->currency_code ?? 'EUR'); ?></div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\IT9_FinancialTracker\resources\views\settings.blade.php ENDPATH**/ ?>