...
<div class="form-card" style="max-width:520px; min-height:440px;">
    ...
    <form method="POST" action="<?php echo e(route('login')); ?>">
        ...
        <div class="form-actions" style="margin-bottom:24px;font-size:14px;">
            ...
            <a href="<?php echo e(route('password.request')); ?>" class="help-link" style="font-size:14px;">Forgot password?</a>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Financial-Tracker\resources\views/login.blade.php ENDPATH**/ ?>