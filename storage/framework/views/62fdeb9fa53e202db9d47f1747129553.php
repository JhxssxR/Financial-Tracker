...
<section class="stack-section">
	...
	<?php $__empty_1 = true; $__currentLoopData = $budgets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $budget): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
		...
		<div class="card budget-card" style="padding:12px; margin-bottom:10px; background:#1a2332;" data-budget-id="<?php echo e($budget->id); ?>" data-category-id="<?php echo e($budget->category_id); ?>">
			<!-- Header -->
			<div class="budget-header" style="display:flex; justify-content:space-between; align-items:flex-start; margin-bottom:8px; gap:8px;">
				<div style="display:flex; align-items:center; gap:8px; flex:1; min-width:0;">
					...
					<div style="min-width:0; flex:1;">
						<h3 style="font-weight:600; font-size:14px; margin:0 0 3px 0; color:#f1f5f9; overflow:hidden; text-overflow:ellipsis; white-space:nowrap;"><?php echo e($budget->category->name ?? $budget->name); ?></h3>
						<?php
							$statusText = 'On Track';
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Financial-Tracker\resources\views/budgets.blade.php ENDPATH**/ ?>