...
<div class="page-header" style="display:flex;align-items:center;gap:12px;">
	...
	<div style="margin-left:auto;display:flex;gap:8px;">
		...
		<a href="{{ route('reports.export') }}" class="card" style="padding:8px 12px;background:#0e7d57;border-color:#0e7d57;cursor:pointer;display:flex;align-items:center;gap:6px;text-decoration:none;color:white;transition:all .2s;" onmouseover="this.style.background='#059669'" onmouseout="this.style.background='#0e7d57'">
...
@push('scripts')
	<script>
		window.__REPORTS_DATA = {
			monthlyData: @json($monthlyData ?? ['months' => [], 'income' => [], 'expenses' => []]),
			expenseCategoryData: @json($expenseCategoryData ?? ['labels' => [], 'data' => [], 'colors' => []]),
