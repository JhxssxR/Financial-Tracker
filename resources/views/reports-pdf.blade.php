...
<body>
    <div class="container">
        ...
        <div class="summary-grid">
            <div class="summary-row">
                ...
                <div class="summary-card savings">
                    ...
                    <div class="value">{{ format_currency($totalSavings) }}</div>
                </div>
            ...
            <div class="monthly-data">
                ...
                <div class="monthly-row">
                    ...
                    <div class="month-values">
                        <span style="color: #10b981;">Income: {{ format_currency($monthlyData['income'][$index]) }}</span> | 
                        <span style="color: #ef4444;">Expenses: {{ format_currency($monthlyData['expenses'][$index]) }}</span>
                    </div>
                </div>
                @endforeach
            </div>
        ...
        <!-- Expense Categories -->
        @if(count($expenseCategoryData['labels']) > 0)
        <div class="section">
            <div class="section-title">💰 Expense Breakdown by Category</div>
            <div class="expense-categories">
                @foreach($expenseCategoryData['labels'] as $index => $label)
                <div class="category-item">
                    <div class="category-name">{{ $label }}</div>
                    <div class="category-amount">{{ format_currency($expenseCategoryData['data'][$index]) }}</div>
                </div>
                @endforeach
            </div>
        </div>
