...
<div class="form-card" style="max-width:520px; min-height:350px;">
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="form-row" style="margin-bottom:14px;">
            <div>
                ...
                <div class="input-wrap">
                    ...
                    <input class="form-input pad-left-icon" type="text" name="first_name" value="{{ old('first_name') }}" placeholder="First name" required style="padding:13px 14px 13px 44px;" />
                </div>
            </div>
            <div>
                <label class="form-label" style="font-size:14px;font-weight:500;margin-bottom:8px;">Last Name</label>
                <div class="input-wrap">
                    <input class="form-input" type="text" name="last_name" value="{{ old('last_name') }}" placeholder="Last name" required style="padding:13px 14px;" />
                </div>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="input-wrap">
                ...
                <input class="form-input pad-left-icon" type="email" name="email" value="{{ old('email') }}" placeholder="Enter your email" required style="padding:13px 14px 13px 44px;" />
            </div>
        </div>
    ...
    <div style="text-align:center;font-size:14px;" class="muted">
        Already have an account? <a class="help-link" href="{{ route('login') }}" style="font-weight:600;">Sign in</a>
    </div>
</div>
