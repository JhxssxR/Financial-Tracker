    ...
    <form method="POST" action="{{ route('password.email') }}">
        ...
        <div class="form-group">
            ...
            <div class="input-wrap">
                ...
                <input class="form-input pad-left-icon" type="email" name="email" value="{{ old('email') }}" placeholder="Enter your email" required autofocus style="padding:13px 14px 13px 44px;" />
            </div>
