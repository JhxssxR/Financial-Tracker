...
<section class="page-grid-3">
    <div class="card card-pad-lg">
        ...
        <div style="font-size:28px;font-weight:700; margin-top:6px;text-align:right;">{{ format_currency($totalSavings) }}</div>
    ...
    <div class="card card-pad-lg">
        ...
        <div class="muted" style="font-size:12px;margin-top:4px;text-align:right;">{{ number_format($expensePercentage, 1) }}% of income</div>
    </div>
</section>
