...
<section class="page-grid-3">
	<div class="card" style="padding:16px;">
		...
		<div id="totalBudgeted" style="font-size:28px;font-weight:700;margin-top:6px;text-align:right;">{{ format_currency($totalBudgeted) }}</div>
	...
	<div class="card" style="padding:16px;">
		...
		<div id="totalSpent" class="danger" style="font-size:28px;font-weight:700;margin-top:6px;text-align:right;">{{ format_currency($totalSpent) }}</div>
	...
	<div class="card" style="padding:16px;">
		...
		<div id="totalRemaining" class="brand" style="font-size:28px;font-weight:700;margin-top:6px;text-align:right;">{{ format_currency($totalRemaining) }}</div>
...
<script>
	...
	function editBudget(id) {
		...
		const budgets = @json($budgets->items());
